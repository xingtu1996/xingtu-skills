...
description: >
  ...
  版本：豆包工作优化版 v1.0（2026-09-03）；原版归档 .backups/skills_原版归档_20260903/adversarial-review_原版归档（内部项目）
---

# 对抗性审查引擎（Adversarial Review Engine · 行途版）

> 来源：原版 adversarial-review（内部项目实践提炼）+ 行途内容工厂五关 + PUB-017 多专家对抗审查
> 适配日期：2026-09-03
...
| 日期 | 版本 | 变更 | 来源 |
|------|:---:|------|------|
| 2026-09-03 | v1.0 | 豆包工作优化版：适配行途公众号（封面/标题/正文/数据审查）+ PUB-017 对齐 + 领域专家表 + 数据核实联动 | 原版 某内部项目 + 某内部代码仓库 |
